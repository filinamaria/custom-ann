...
public class DeltaRuleIncremental extends Classifier{
	 ...
	 * @param maxIteration
	 */
	public DeltaRuleIncremental(double learningRate, double threshold, int maxIteration){
	 ...
	 * @param initialWeight
	 */
	public DeltaRuleIncremental(double learningRate, double threshold, int maxIteration, double initialWeight){
		this.learningRate = learningRate;
		this.threshold = threshold;
		this.maxIteration = maxIteration;
	...
	public static void main(String[] args) throws Exception{
		...
		DeltaRuleIncremental ptr = new DeltaRuleIncremental(0.1, 0.01, 10, 0);
