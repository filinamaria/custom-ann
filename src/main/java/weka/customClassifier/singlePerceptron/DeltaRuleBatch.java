...
public class DeltaRuleBatch extends Classifier{
	 ...
	 * @param maxIteration
	 */
	public DeltaRuleBatch(double learningRate, double threshold, int maxIteration){
	 ...
	 * @param initialWeight
	 */
	public DeltaRuleBatch(double learningRate, double threshold, int maxIteration, double initialWeight){
		this.learningRate = learningRate;
		this.threshold = threshold;
		this.maxIteration = maxIteration;
	...
	public static void main(String[] args) throws Exception{
		...
		DeltaRuleBatch ptr = new DeltaRuleBatch(0.1, 0.01, 10, 0);
